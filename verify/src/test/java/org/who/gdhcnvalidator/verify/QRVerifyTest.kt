...
class QRVerifyTest: BaseTrustRegistryTest() {
    ...
    @Test
    fun verifyDVC2() {
        verify("DVCTest2QR.txt", "DVCTest2QRFHIRBundle.json", QRDecoder.Status.INVALID_SIGNATURE)
    }

    @Test
    fun verifyDVC3() {
        verify("DVCTest3QR.txt", "DVCTest3QRFHIRBundle.json", QRDecoder.Status.VERIFIED)
    }
